...
class VideoPlayer(QWidget):
    ...
    def extract_and_display_roi(self):
        ...
        # 顯示 RGB 通道和原始 ROI
        self.show_image(self.ui.red_channel_label, r_img)
        self.show_image(self.ui.green_channel_label, g_img)
        self.show_image(self.ui.blue_channel_label, b_img)
        self.show_image(self.ui.original_roi_label, self.roi)
    ...
    def update_histogram(self):
        ...
        # 繪製直方圖
        self.ax.clear()
        self.ax.hist(channel_data, bins=intervals, range=(
            0, 256), color='blue' if mode == 1 else 'green' if mode == 2 else 'red')
